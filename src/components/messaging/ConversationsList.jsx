      ...
      <div className="p-4 border-b border-border">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-background border border-input text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent"
          />
        </div>
      </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      <div className="w-12 h-12 overflow-hidden border-2 border-border bg-muted flex-shrink-0">
                      ...
                      <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-background"></div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-sm text-muted-foreground truncate">
                          {isOwnMessage && <span className="text-muted-foreground/70">You: </span>}
                          {truncateMessage(conversation.lastMessage.message)}
                        </p>
                        {conversation.unreadCount > 0 && (
                          <span className="ml-2 bg-primary text-primary-foreground text-xs px-2 py-1 min-w-[20px] text-center flex-shrink-0">
